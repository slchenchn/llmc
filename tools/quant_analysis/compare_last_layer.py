...
def analysis_massive_outlier(
    ...
    inspect_key = "block_61.input_layernorm"
    ori_act = ori_res[inspect_key].max(dim=0)[0]  # remove the batch dimension
    prefixed_act = prefixed_res[inspect_key].max(dim=0)[0]
...
if __name__ == "__main__":
    pickled_res_paths = [
        {
            "ori_res": "analysis_model/DeepSeek-R1/bf16/pickled/20250423_041048/block61.res.pkl",
            "prefixed_res": "analysis_model/DeepSeek-R1/bf16/pickled/20250423_023357/block61.res.pkl",
            "save_dir": "analysis_model/DeepSeek-R1/bf16/PrefixQuant/block61",
        },
        {
            "ori_res": "analysis_model/DeepSeek-R1/quarot/sym_w8a8_dynamic2/pickled/20250423_041048/block61.res.pkl",
            "prefixed_res": "analysis_model/DeepSeek-R1/quarot/sym_w8a8_dynamic2/pickled/20250423_023357/block61.res.pkl",
            "save_dir": "analysis_model/DeepSeek-R1/quarot/sym_w8a8_dynamic2/PrefixQuant/block61",
        },
    ]

...
def rotate_mtp_embeddings(state_dict, mtp_pat, rotated_emb, had_mat):
    ...
    plot_histogram(
        ...
        f"logs/mtp_hists_v2/{mtp_pat}eh_proj_after_first_rotation.png",
    ...
    plot_histogram(
        ...
        f"logs/mtp_hists_v2/{mtp_pat}eh_proj_after_second_rotation.png",
        split_by_second_dim=True,
    )
    ...
    mtp_emb = mtp_emb.double() @ had_mat
...
if __name__ == "__main__":
    ...
    save_model_dir = rotated_model_root / "vllm_quant_model_mtp_v2"
    n_bits = 8
    ...
    log_file = "logs/quant_mtp_block_v2.log"
    logger.add(log_file)
